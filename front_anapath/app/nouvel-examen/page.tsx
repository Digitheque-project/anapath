          ...
          {anaType === 'fcv' && (
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="bg-white rounded-xl shadow-sm border p-5">
                ...
                <input aria-label="Unité / Service demandeur" title="Unité / Service demandeur" name="serviceDemandeur" value={formData.serviceDemandeur} onChange={handleChange} className="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm" placeholder="Service clinique prescripteur" />
              </div>
              <div className="bg-white rounded-xl shadow-sm border p-5">
                <h3 className="font-bold text-[#00478d] mb-4">Antécédents</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div><label className="text-xs font-bold text-gray-500 uppercase block mb-1">G P A</label><input aria-label="GPA" title="GPA" name="fcvGpa" value={formData.fcvGpa} onChange={handleChange} className="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm" placeholder="Ex : G3 P2 A1" /></div>
                  <div><label className="text-xs font-bold text-gray-500 uppercase block mb-1">DDR</label><input aria-label="Date des dernières règles" title="Date des dernières règles" name="fcvDdr" value={formData.fcvDdr} onChange={handleChange} className="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm" type="date" /></div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="bg-white rounded-xl shadow-sm border p-5">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div><label className="text-xs font-bold text-gray-500 uppercase block mb-1">Organe</label><input aria-label="Organe" title="Organe" name="cytoOrgane" value={formData.cytoOrgane} onChange={handleChange} className="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm" placeholder="Ex : thyroïde, ganglion..." /></div>
                </div>
